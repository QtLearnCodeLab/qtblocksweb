...
/* --- QtPi JS Generator: colour.js --- */
/**
 * QtPi Colour JavaScript Generators
 */
'use strict';

Blockly.JavaScript['colour_picker'] = function(block) {
  var code = Blockly.JavaScript.quote_(block.getFieldValue('COLOUR') || '#ff0000');
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.JavaScript['colour_random'] = function(block) {
  var functionName = Blockly.JavaScript.provideFunction_('colour_random', [
...
Blockly.JavaScript['colour_rgb'] = function(block) {
  var functionName = Blockly.JavaScript.provideFunction_('colour_rgb', [
    'function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + '(r, g, b) {',
    '  r = Math.round(Math.max(Math.min(Number(r), 100), 0) * 2.55);',
    '  g = Math.round(Math.max(Math.min(Number(g), 100), 0) * 2.55);',
    '  b = Math.round(Math.max(Math.min(Number(b), 100), 0) * 2.55);',
  ...
  return [functionName + '(' + red + ', ' + green + ', ' + blue + ')', Blockly.JavaScript.ORDER_FUNCTION_CALL];
};

Blockly.JavaScript['colour_blend'] = function(block) {
  var functionName = Blockly.JavaScript.provideFunction_('colour_blend', [
  ...
  var c1 = Blockly.JavaScript.valueToCode(block, 'COLOUR1', Blockly.JavaScript.ORDER_NONE) || "'#000000'";
  var c2 = Blockly.JavaScript.valueToCode(block, 'COLOUR2', Blockly.JavaScript.ORDER_NONE) || "'#000000'";
  var ratio = Blockly.JavaScript.valueToCode(block, 'RATIO', Blockly.JavaScript.ORDER_NONE) || 0;
  return [functionName + '(' + c1 + ', ' + c2 + ', ' + ratio + ')', Blockly.JavaScript.ORDER_FUNCTION_CALL];
};


/* --- QtPi JS Generator: processjs.js --- */
/**
 * @license
...
goog.provide('Blockly.JavaScript.processjs');

goog.require('Blockly.JavaScript');

// Any imports need to be reserved words
Blockly.JavaScript.addReservedWords('processjs');
...
/* --- QtPi JS Generator: text.js --- */
/**
 * QtPi Custom Text JavaScript Generators
 */
'use strict';

Blockly.JavaScript['replace'] = function(block) {
  var string_object = Blockly.JavaScript.valueToCode(block, 'string_object', Blockly.JavaScript.ORDER_ATOMIC) || "''";
  var old_str = Blockly.JavaScript.valueToCode(block, 'old', Blockly.JavaScript.ORDER_ATOMIC) || "''";
  var new_str = Blockly.JavaScript.valueToCode(block, 'new', Blockly.JavaScript.ORDER_ATOMIC) || "''";
  return [string_object + '.replace(' + old_str + ', ' + new_str + ')', Blockly.JavaScript.ORDER_MEMBER];
};

Blockly.JavaScript['check_string'] = function(block) {
  var check_str = Blockly.JavaScript.valueToCode(block, 'check_string', Blockly.JavaScript.ORDER_ATOMIC) || "''";
  var string_object = Blockly.JavaScript.valueToCode(block, 'string_object', Blockly.JavaScript.ORDER_ATOMIC) || "''";
  return [string_object + '.includes(' + check_str + ')', Blockly.JavaScript.ORDER_MEMBER];
};
