...
Blockly.Msg.CAT_VARIABLE = "↝ Variable";
Blockly.Msg.CAT_FUNCTION = "∬ Function";
...
Blockly.Msg.CAT_DICTONARY = "{} Dictionary";
Blockly.Msg.CAT_SET = "⊞ Set";
Blockly.Msg.CAT_TUPLE = "() Tuple";
Blockly.Msg.CAT_COLOUR = "▀ Colour";
Blockly.Msg.QtPi_Neo = "QtPi Neo";
Blockly.Msg.Code_and_Comments = "Code Segment";
Blockly.Msg.Connectivity = "Connectivity";
Blockly.Msg.System = "System";
Blockly.Msg.Streamlit = "Streamlit";
Blockly.Msg.Microbit = "Microbit";
Blockly.Msg.QtPy = "QtPy";
Blockly.Msg.QTPI_BOARD = "QtPi Neo";
Blockly.Msg.Time = "Time";
Blockly.Msg.Services = "Services";
Blockly.Msg.Conversions = "Conversions";
...
//Wireless
Blockly.Msg.neo = "initialization of the wifi module and connection with the indicated parameters";
Blockly.Msg.neo_ = "Esp 8266";
Blockly.Msg.neo_2 = "SSID";
Blockly.Msg.neo_3 = "key";
Blockly.Msg.neo_4 = "IP";
Blockly.Msg.neo_5 = "gateway";
Blockly.Msg.neo_6 = "mask";
Blockly.Msg.neo_7 = [["client", "client"], ["server", "server"]];
Blockly.Msg.neo_8 = "port";
Blockly.Msg.neo_9 = [["dynamic", "dynamic"], ["static", "static"]];
Blockly.Msg.neo_10 = "address";
Blockly.Msg.neo_recept_tooltip = "reception";
Blockly.Msg.neo_url = "https://github.com/OttoDIY/esp";
Blockly.Msg.neo_html_tooltip = "";
Blockly.Msg.neo_send_html_tooltip = "";
Blockly.Msg.neo_send_html = "send HTML page";
Blockly.Msg.neo_start_tooltip = "";
Blockly.Msg.neo_start = "start server";
Blockly.Msg.neo_request_tooltip = "";
Blockly.Msg.neo_request = "if in the query we find";
Blockly.Msg.neo_request_container = "we find";

//Wireless
Blockly.Msg.microbit_init_tooltip = "initialization of the wifi module and connection with the indicated parameters";
Blockly.Msg.microbit_1 = "Esp 8266";
Blockly.Msg.microbit_2 = "SSID";
Blockly.Msg.microbit_3 = "key";
Blockly.Msg.microbit_4 = "IP";
Blockly.Msg.microbit_5 = "gateway";
Blockly.Msg.microbit_6 = "mask";
Blockly.Msg.microbit_7 = [["client", "client"], ["server", "server"]];
Blockly.Msg.microbit_8 = "port";
Blockly.Msg.microbit_9 = [["dynamic", "dynamic"], ["static", "static"]];
Blockly.Msg.microbit_10 = "address";
Blockly.Msg.microbit_recept_tooltip = "reception";
Blockly.Msg.microbit_url = "https://github.com/OttoDIY/esp";
Blockly.Msg.microbit_html_tooltip = "";
Blockly.Msg.microbit_send_html_tooltip = "";
Blockly.Msg.microbit_send_html = "send HTML page";
Blockly.Msg.microbit_start_tooltip = "";
Blockly.Msg.microbit_start = "start server";
Blockly.Msg.microbit_request_tooltip = "";
Blockly.Msg.microbit_request = "if in the query we find";
Blockly.Msg.microbit_request_container = "we find";
